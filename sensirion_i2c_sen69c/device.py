...
#
"""
The class Sen69cDeviceBase implements the low level interface of the sensor.
The class Sen69cDevice extends the Sen69cDeviceBase. It provides additional functions to ease the use of the
sensor.
"""
...
from sensirion_i2c_sen69c.commands import (ActivateShtHeater, DeviceReset, DeviceStatus, GetAmbientPressure,
                                           ...
                                           GetVocAlgorithmTuningParameters, PerformCo2SensorFactoryReset,
...
from sensirion_i2c_sen69c.result_types import (SignalDividedBy10Int16, SignalDividedBy10Uint16, SignalHumidity,
                                               SignalTemperature)


class Sen69cDeviceBase:
    """Low level API implementation of SEN69C"""
    ...
    def read_measured_values_as_integers(self):
        ...
        :return co2:
            ...
            *Note: If this value is unknown, 0x7FFF is returned. During the first
            22..24 seconds starting a measurement, this value will be 0x7FFF.*
        """
...
class Sen69cDevice(Sen69cDeviceBase):
    """Driver class implementation of SEN69C"""
    ...
    def read_measured_values(self):
        ...
        return (SignalDividedBy10Uint16(mass_concentration_pm1p0_raw),
                ...
                SignalDividedBy10Int16(nox_index_raw), SignalDividedBy10Uint16(hcho_raw), co2_raw)
